...
public class DoublyLinkedList<T> {
    ...
    public interface InsertionStrategy<E> {
    ...
    public void insertBehindSelected (InsertionStrategy<T> s){
        ...
        while (current != null){
            if (s.select(current.getContent())){
                ...
                Element ins = new Element(s.insert(current.getContent()));
                current.connectAsSucc(ins);
                current.succ.connectAsSucc(next);
                current = next;
            }
            else current = current.getSucc();
        }
    }
